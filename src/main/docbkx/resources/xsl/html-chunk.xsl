        ...
        <div id="top">
            <div id="header">
                <div class="projectlogo">
                    <a href="./"><img class="logoImage" src="images/logo_small.png" alt="Project Logo" border="0" /></a>
                </div>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td width="20%" align="center">
                                    <span style="color:white;font-size:85%;">
                                        <a href="http://www.artivisi.com" title="ArtiVisi Intermedia">ArtiVisi Intermedia</a>
                                    </span>
                                </td>
